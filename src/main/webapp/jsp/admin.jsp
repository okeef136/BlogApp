...
<body>
    ...
    <div class="container"> 
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h1 class="newpost" style="text-align: center">Pending Posts</h1>
                <table id="postTable" class="table">
                    <tbody id="content-divs"></tbody>
                </table>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6" >
                <h1 class="newpost" style="text-align: center">Static Pages</h1>
                <table id="static-pages-table" class="table table-hover">
                    <tr>
                        <th width="50%">Title</th>
                        <th width="50%"></th>
                    </tr>
                    <tbody id="static-pages-rows"></tbody>
                </table> 
            </div>
        </div>
        <footer> </footer>
    ...
    <script type="text/babel" src="${pageContext.request.contextPath}/js/blogadmin.js"></script>
